    ...
    async () => {
      ...
      if (includeItems.includes("revenue")) {
        const revenueData = await db
          .select({
            id: financialRevenueItems.id,
            amount: financialRevenueItems.amount,
            category: financialRevenueItems.category,
            notes: financialRevenueItems.notes,
            evidence_url: financialRevenueItems.evidenceUrl,
            sort_order: financialRevenueItems.sortOrder,
            created_at: financialRevenueItems.createdAt,
          })
          .from(financialRevenueItems)
          .orderBy(asc(financialRevenueItems.sortOrder));
      ...
      if (includeItems.includes("costs")) {
        const costData = await db
          .select({
            id: financialCostItems.id,
            amount: financialCostItems.amount,
            category: financialCostItems.category,
            notes: financialCostItems.notes,
            evidence_url: financialCostItems.evidenceUrl,
            sort_order: financialCostItems.sortOrder,
            created_at: financialCostItems.createdAt,
          })
          .from(financialCostItems)
          .orderBy(asc(financialCostItems.sortOrder));
