...
const features = [
  {
    ...
    description:
      "Our intelligent platform connects you with the most relevant business partners using advanced algorithms.",
  ...
  },
  {
    ...
    description:
      "Experience seamless event operations with our AI-driven workforce coordination system.",
  ...
  },
  {
    ...
    description:
      "15 specialized teams ensuring a flawless experience for all attendees and exhibitors.",
  ...
  },
  {
    ...
    title: "Global Reach",
    description:
      "Connect with 1,800+ attendees from 25+ Indonesian regions and beyond.",
  ...
  },
  {
    ...
    description:
      "Access to high-value investment opportunities and strategic partnerships.",
  ...
  },
  {
    ...
    description:
      "Experience the rich diversity of Indonesian culture through authentic performances and exhibitions.",
    ...
    <section id="features" className="relative py-20 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            Discover what makes Nusantara Messe 2026 the premier platform for
            ...
            >
              <div
                ...
                style={{
                  ...
                  }10, ${feature.color.split(" ")[3]}10)`,
                }}
              ></div>

              <div
                className={`inline-flex items-center justify-center w-12 h-12 mb-6 rounded-xl bg-gradient-to-br ${feature.color} text-white`}
              >
                {feature.icon}
              </div>
