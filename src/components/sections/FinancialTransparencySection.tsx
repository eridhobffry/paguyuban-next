...
const majorCosts = [
  {
    ...
    percentage: 21,
    color: "#ef4444",
    description: "Arena Berlin rental, utilities, staff",
  },
  {
    ...
    percentage: 23,
    color: "#8b5cf6",
    description: "Digital campaigns, influencers, PR",
  },
  {
    ...
    percentage: 17,
    color: "#3b82f6",
    description: "Core team, volunteers, freelancers",
  },
  {
    ...
    percentage: 17,
    color: "#f59e0b",
    description: "Dewa 19, Tulus, ERK, Panturas, DJs",
  },
  {
    ...
    percentage: 8,
    color: "#10b981",
    description: "NusantaraConnect & SmartStaff platforms",
  },
  {
    ...
    percentage: 14,
    color: "#6b7280",
    description: "Speakers, insurance, logistics, contingency",
  },
];
