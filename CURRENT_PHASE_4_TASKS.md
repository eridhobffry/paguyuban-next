...
- **Done**
  ...
  - Analytics sessionizer endpoint: `/api/admin/analytics/sessionize` closes stale sessions and computes engagement score with a capped threshold; button added to admin analytics to run it on demand.
...
- **In Progress**
- **Next**
  - Analytics: schedule sessionizer (cron/edge scheduled) and expose engagement trend/avg on dashboard.
